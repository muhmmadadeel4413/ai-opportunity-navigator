          ...
          <AnimatedSection>
            <div className="relative">
              ...
              <p className="mt-4 text-lg text-foreground/60 max-w-2xl">
                Your AI-powered career navigator. Discover, track, and land
                the opportunities that fit you best.
              </p>
            </div>
          </AnimatedSection>
        </section>
          ...
          <div className="relative bg-gradient-to-br from-accent/5 via-surface to-surface border border-border rounded-2xl p-8 md:p-12 shadow-sm mb-10 overflow-hidden">
            ...
            <div className="relative max-w-2xl mx-auto text-center">
              ...
              <p className="text-foreground/60 mb-8 max-w-lg mx-auto">
                Our AI analyzes your profile against hundreds of
                opportunities — internships, scholarships, hackathons, and
                more. Get personalized matches with explanations of why each
                one fits you.
              </p>
          ...
          <div className="relative bg-gradient-to-br from-primary/5 via-secondary/5 to-accent/5 rounded-2xl border border-border p-8 md:p-10 text-center overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-foreground/60 max-w-xl mx-auto mb-6">
                Keep your profile up to date so our AI can find the best
