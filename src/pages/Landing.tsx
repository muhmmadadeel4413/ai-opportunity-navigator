...
const problems = [
  {
    icon: Search,
    title: "Scattered Searches",
    desc: "Manually browsing dozens of sites for opportunities",
  },
  {
    icon: Bell,
    title: "Missed Deadlines",
    desc: "Losing track of application due dates and requirements",
  },
  {
    icon: Target,
    title: "No Personalization",
    desc: "Generic recommendations that don't match your skills",
  },
  {
    icon: BarChart3,
    title: "No Tracking",
    desc: "No centralized way to track your applications",
  },
  {
    icon: Code,
    title: "Unknown Skills",
    desc: "Not knowing what skills you need for your dream role",
  },
  {
    icon: Compass,
    title: "Lack of Guidance",
    desc: "No clear career roadmap or mentor-like advice",
  },
];
...
const services = [
  {
    ...
    desc: "Discover internships tailored to your field of study.",
    gradient: "from-blue-500 to-cyan-500",
  },
  {
    icon: GraduationCap,
    title: "Scholarship Finder",
    desc: "Find scholarships matching your academic profile.",
    gradient: "from-emerald-500 to-teal-500",
  },
  {
    icon: Zap,
    title: "Hackathon Discovery",
    desc: "Stay updated on upcoming hackathons and competitions.",
    gradient: "from-purple-500 to-pink-500",
  },
  {
    icon: Award,
    title: "Competition Explorer",
    desc: "Case competitions, olympiads, and challenges.",
    gradient: "from-amber-500 to-orange-500",
  },
  {
    icon: Star,
    title: "Fellowship Programs",
    desc: "Find prestigious fellowships and leadership programs.",
    gradient: "from-rose-500 to-red-500",
  },
  {
    icon: Building2,
    title: "Job Opportunities",
    desc: "Get matched with jobs that fit your goals.",
    gradient: "from-indigo-500 to-violet-500",
  },
  {
    icon: BookOpen,
    title: "Bootcamp Discovery",
    desc: "Explore coding bootcamps and intensive programs.",
    gradient: "from-sky-500 to-blue-500",
  },
  {
    icon: Cpu,
    title: "AI Career Guidance",
    desc: "Personalized career advice powered by AI.",
...
const features = [
  {
    ...
    desc: "Intelligent search that understands your skills.",
  },
  {
    icon: Cpu,
    title: "AI Recommendations",
    desc: "Personalized opportunities recommended by ML.",
  },
  {
    icon: Target,
    title: "Match Score",
    desc: "See how well each opportunity aligns with you.",
  },
  {
    icon: BarChart3,
    title: "Skill Gap Analysis",
    desc: "Identify missing skills and learn them.",
  },
  {
    icon: FileText,
  ...
  },
  {
    ...
    desc: "Visual roadmap showing your career path.",
  },
  {
    icon: Bookmark,
    title: "Saved Opportunities",
    desc: "Bookmark and revisit anytime.",
  },
  {
    icon: Clock,
  ...
  },
  {
    ...
    desc: "Track every application stage in one place.",
  },
  {
    icon: MessageCircle,
    title: "AI Career Coach",
    desc: "Chat with an AI coach for instant guidance.",
  },
];
...
const steps = [
  {
    ...
    desc: "Tell us about your education, skills, and goals in minutes.",
    icon: FileText,
  },
  {
    num: "02",
    title: "AI Analyzes Your Profile",
    desc: "Our AI processes your profile to understand your strengths.",
    icon: Cpu,
  },
  {
    num: "03",
    title: "Get Personalized Matches",
    desc: "Receive curated opportunities ranked by fit.",
    icon: Sparkles,
  },
  {
    num: "04",
    title: "Apply & Track Progress",
    desc: "Apply directly and track everything in one dashboard.",
    icon: TrendingUp,
  },
];
...
const faqs = [
  {
    q: "What is AI Opportunity Navigator?",
    a: "An intelligent career platform that helps students discover personalized opportunities using AI-powered matching.",
  },
  {
    q: "Is it free to use?",
    a: "Yes! Completely free for students and job seekers. Create your profile and start receiving recommendations.",
  },
  {
    q: "How does AI matching work?",
    a: "Our AI analyzes your profile — education, skills, interests — and compares against thousands of opportunities to find the best matches.",
  },
  {
    q: "What opportunities can I find?",
    a: "Internships, scholarships, hackathons, competitions, fellowships, jobs, and bootcamps — all in one place.",
  },
  {
    q: "How do I track applications?",
    a: "Your dashboard gives a complete view of all applications, statuses, upcoming deadlines, and next steps.",
  },
  {
    q: "Can I update my profile later?",
    a: "Absolutely! Update anytime and the AI will re-evaluate your recommendations.",
  },
];
...
const testimonials = [
  {
    ...
    avatar: "SC",
    quote:
      "I found my dream internship through OppNav. The match scores made it so easy to know which opportunities were worth my time.",
    rating: 5,
  },
  {
    name: "Marcus Johnson",
    ...
    avatar: "MJ",
    quote:
      "The skill gap analysis was a game-changer. I knew exactly what to learn. Landed a role in 3 months.",
    rating: 5,
  },
  {
    name: "Priya Patel",
    ...
    avatar: "PP",
    quote:
      "I was missing deadlines everywhere. Now I get reminders and track everything from one dashboard.",
    rating: 5,
  },
];
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <button
              ...
              className="lg:hidden p-2 rounded-xl hover:bg-foreground/5 transition-colors cursor-pointer"
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="text-center lg:text-left">
              ...
              <AnimatedSection>
                <p className="mt-6 text-lg sm:text-xl text-foreground/60 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                  Discover internships, scholarships, hackathons,
                  fellowships, competitions, jobs, and bootcamps
                  personalized for your skills and career goals.
                </p>
              </AnimatedSection>
                ...
                <div className="mt-10 flex flex-wrap items-center gap-6 justify-center lg:justify-start">
                  <div className="flex -space-x-2">
                    {["SC", "MJ", "PP", "AK"].map((initials, i) => (
                      <div
                        key={i}
                        className="w-8 h-8 rounded-full bg-gradient-to-br from-primary to-secondary text-white text-[10px] font-bold flex items-center justify-center border-2 border-background"
                      >
                        {initials}
                      </div>
                    ))}
            ...
            <AnimatedSection>
              <div className="relative">
                <div className="relative bg-surface rounded-2xl border border-border shadow-2xl shadow-primary/10 overflow-hidden">
                  ...
                  <div className="p-5 space-y-4">
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl p-4 border border-primary/10">
                        ...
                        <div className="flex items-end gap-1">
                          ...
                          <span className="text-sm text-foreground/40 mb-1">
                            /100
                          </span>
                        </div>
                      ...
                      <div className="bg-gradient-to-br from-accent/10 to-accent/5 rounded-xl p-4 border border-accent/10">
                        ...
                        <p className="text-sm text-foreground/70 leading-snug">
                          ...
                          internships. Consider adding Python libraries.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      {dashboardItems.map((item, i) => (
                        <div
                          key={i}
                          className="flex items-center justify-between px-3.5 py-2.5 rounded-lg border border-border hover:border-primary/20 hover:bg-primary/[0.02] transition-all cursor-pointer"
                        >
                ...
                <div className="absolute -top-3 -right-3 bg-accent text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg animate-bounce">
                  AI Powered
                </div>
              </div>
            </AnimatedSection>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="mt-4 text-lg text-foreground/60">
              Students spend hours browsing multiple platforms, yet still
            ...
            {problems.map((problem, i) => {
              ...
              return (
                <AnimatedSection key={i} threshold={0.1}>
                  <div className="group relative bg-surface rounded-2xl border border-border p-6 hover:shadow-lg hover:shadow-primary/5 hover:border-primary/20 transition-all duration-300 cursor-default">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <AnimatedSection>
              ...
              <p className="mt-4 text-lg text-foreground/60 leading-relaxed">
                AI Opportunity Navigator brings everything together in one
                intelligent platform. No more juggling tabs, spreadsheets,
                and bookmarks.
              </p>
                ...
                {[
                  {
                    ...
                    desc: "Our AI analyzes your unique profile and finds opportunities that truly fit.",
                  },
                  {
                    icon: Search,
                    title: "Smart Search Across All Platforms",
                    desc: "One search covers internships, scholarships, hackathons, jobs, and more.",
                  },
                  {
                    icon: Compass,
                    title: "Personalized Career Guidance",
                    desc: "Get mentor-like advice, skill recommendations, and a clear roadmap.",
                  },
                  {
                    icon: Layers,
                    title: "Centralized Application Tracking",
                    desc: "Track every application, deadline, and status from one dashboard.",
                  },
                ].map((solution, i) => {
                ...
                <div className="bg-gradient-to-br from-primary/5 via-secondary/5 to-accent/5 rounded-3xl p-8 border border-border">
                  <div className="grid grid-cols-2 gap-4">
                    {[
                      ...
                      <div
                        key={i}
                        className="bg-surface rounded-2xl p-5 border border-border text-center hover:shadow-md transition-shadow"
                      >
                        <p
                  ...
                  <div className="mt-6 p-5 bg-surface rounded-2xl border border-border">
                    ...
                    <p className="text-sm text-foreground/70 italic leading-relaxed">
                      &ldquo;This platform changed how I find opportunities.
                      The AI recommendations are surprisingly accurate.&rdquo;
                    </p>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="mt-4 text-lg text-foreground/60">
              From internships to career guidance, we&apos;ve got every
              opportunity type covered.
            </p>
          </AnimatedSection>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {services.map((service, i) => {
              ...
              return (
                <AnimatedSection key={i} threshold={0.1}>
                  <div className="group bg-surface rounded-2xl border border-border p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-default">
                    <div
                      className={`w-12 h-12 rounded-xl bg-gradient-to-br ${service.gradient} flex items-center justify-center mb-4 shadow-lg transition-transform duration-300 group-hover:scale-110`}
                    >
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center max-w-3xl mx-auto mb-14">
            ...
            <p className="mt-4 text-lg text-foreground/60">
              Powerful tools to help you discover, track, and land the
              perfect opportunity.
            </p>
          </AnimatedSection>
            ...
            {features.map((feature, i) => {
              ...
              return (
                <AnimatedSection key={i} threshold={0.05}>
                  <div className="group bg-surface rounded-2xl border border-border p-5 hover:shadow-lg hover:border-primary/20 hover:-translate-y-0.5 transition-all duration-300 cursor-default text-center">
      ...
      <section
        id="how-it-works"
        className="relative py-20 md:py-28 bg-gradient-to-b from-background to-muted/50"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center max-w-3xl mx-auto mb-14">
          ...
          <div className="grid md:grid-cols-4 gap-6 lg:gap-8">
            {steps.map((step, i) => {
              ...
              return (
                <AnimatedSection key={i} threshold={0.1}>
                  <div className="relative bg-surface rounded-2xl border border-border p-6 text-center hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((testimonial, i) => (
              <AnimatedSection key={i} threshold={0.1}>
                <div className="bg-surface rounded-2xl border border-border p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <AnimatedSection>
              ...
              <p className="mt-4 text-lg text-foreground/60 leading-relaxed">
                At AI Opportunity Navigator, we believe every student deserves
                access to the best opportunities. Our AI-powered platform
                eliminates the noise and delivers personalized recommendations
                that match your unique skills, interests, and career goals.
              </p>
                ...
                <div className="bg-surface rounded-3xl border border-border p-8 shadow-xl">
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      "AI-powered matching saves hours of manual searching",
                      "Track every application in one centralized dashboard",
                      "Get personalized skill recommendations to improve",
                  ...
                  <div className="mt-6 p-4 bg-gradient-to-br from-primary/5 to-secondary/5 rounded-2xl border border-primary/10">
                    <p className="text-sm text-foreground/70 italic">
                      &ldquo;Your career journey starts with the right
                      opportunity. Let AI guide you.&rdquo;
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section id="faq" className="relative py-20 md:py-28">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-3">
            {faqs.map((faq, i) => (
              <AnimatedSection key={i} threshold={0.05}>
                <div className="bg-surface rounded-2xl border border-border overflow-hidden transition-all duration-300 hover:shadow-md">
                  <button
                    onClick={() =>
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <AnimatedSection>
            ...
            <p className="mt-6 text-lg sm:text-xl text-foreground/60 max-w-2xl mx-auto">
              ...
              personalized opportunities with AI. It&apos;s free, and it
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="sm:col-span-2 lg:col-span-2">
              ...
              <p className="text-foreground/60 text-sm max-w-md leading-relaxed">
                AI Opportunity Navigator helps students discover internships,
                scholarships, hackathons, fellowships, competitions, jobs,
                and bootcamps — all personalized by AI.
              </p>
              ...
              <div className="flex items-center gap-4 mt-6">
                {[Star, MessageCircle, Search, Bell].map((Icon, i) => (
                  <div
                    key={i}
                    className="w-9 h-9 rounded-xl bg-foreground/10 flex items-center justify-center hover:bg-foreground/20 transition-colors cursor-pointer"
                  >
            ...
            <div>
              <h3 className="font-heading font-semibold text-sm text-foreground/60 mb-4">
                Quick Links
              </h3>
          ...
          <div className="mt-10 pt-6 border-t border-border text-center">
            <p className="text-xs text-foreground/40">
              &copy; {new Date().getFullYear()} AI Opportunity Navigator.
              Built for students, by dreamers.
            </p>
          </div>
        </div>
      </footer>
